...
{
    public class AssetsBorrowController : ApproveMasterController
    {
        AssetsBorrowRepository Repository;
        public AssetsBorrowController()
        {
            ControllerName = "AssetsBorrow";
        }

        protected override IApproveMasterFactory CreateRepository()
        {
            Repository = new AssetsBorrowRepository();
            return new ApproveMasterRepositoryFactory<AssetsBorrowRepository>(Repository);
        }
