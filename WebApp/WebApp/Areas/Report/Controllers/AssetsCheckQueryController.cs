...
{
    public class AssetsCheckQueryController : QueryController
    {

        public AssetsCheckQueryController()
        {
            ControllerName = "AssetsCheckQuery";
            Repository = new AssetsCheckQueryRepository();
        }
        ...
        public ActionResult Entry(string pageId, string formMode, string viewTitle)
        {
            ...
            {
                AppLog.WriteLog(AppMember.AppText["SystemUser"], LogType.Error, "AssetsCheckQueryController.Entry", "[Message]:" + ex.Message + " [StackTrace]:" + ex.StackTrace);
